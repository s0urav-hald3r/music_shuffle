...
import 'package:music_shuffle/models/spl_model.dart' hide Image;
import 'package:music_shuffle/views/home/songs_view.dart';

class SPlaylistCard extends StatelessWidget {
  final SplModel model;
  const SPlaylistCard({super.key, required this.model});
